...
api_context.port = 18349
api_context.path = '/ipg/v1x/b2bPayment/'
api_context.add_header('Origin', '*')

async def mpesa_payout_host_with_contract(input_trans_id: str, company_mpesa_contract: str, 
    ...
    api_context.add_parameter('input_PrimaryPartyCode',ServiceProviderCode)
    api_context.add_parameter('input_ReceiverPartyCode',company_mpesa_contract)
